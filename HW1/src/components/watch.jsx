...
export const Watch = ({seconds}) => {
    ...
    return (
      <div >
        ...
        <img className='Clock Hour' src={ClockFace_H} style={{transform: `rotate(${hour*30}deg)`}}  alt=""/>
        <img className='Clock Minute' src={ClockFace_M} style={{transform: `rotate(${min*6}deg)`}}  alt=""/>
        <img className='Clock Sec' src={ClockFace_S} style={{transform: `rotate(${sec*6}deg)`}}  alt=""/>
      </div>  
    )
  }